 ...
 *
 * Configuration settings for the Freescale i.MX6UL Gateway board.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */
#ifndef __MX6UL_GATEWAY_CONFIG_H
#define __MX6UL_GATEWAY_CONFIG_H
	...
	"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0" \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				...
				"if test $board_name = EVK && test $board_rev = 14X14; then " \
					"setenv fdt_file imx6ul-gateway.dtb; fi; " \
				"if test $fdt_file = undefined; then " \
...
#include "mx6ul_gateway_android.h"
#endif

#if defined(CONFIG_ANDROID_THINGS_SUPPORT)
#include "mx6ul_gatewayandroidthings.h"
#endif
#endif
